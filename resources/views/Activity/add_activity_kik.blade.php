	...
	<div class="row vertical-center-row">
		<div class="text-center col-md-5 col-md-offset-4">
			<div class="panel panel-default">
				<div class="panel-heading" style='background-color: #b3b5ff'><b>Add Activity (KIK)</b></div>
				
				{!! Form::open(['url' => 'insert_activity_kik']) !!}
				...
				<br>
				<div class="">
						<a href="{{url('/activity_kik')}}" class="btn btn-default btn-lg center-block">Back to main menu</a>
				</div>
			</div>
		</div>
	</div>
